class PlaceModel {
  final String image, englishTitle, kurdishTitle;
  double latitude, longitude;
  final int id;
  List<dynamic> feedbacks;

  PlaceModel(
      {required this.id, required this.englishTitle, required this.kurdishTitle, required this.image, required this.latitude, required this.longitude, required this.feedbacks}
      ) {
